...
import (
	...
	"gotradebot/exchanges/orderbook"
	"gotradebot/exchanges/ticker"
	"gotradebot/exchanges/wshandler"
	log "gotradebot/logger"
)

// Start starts the NGKEX go routine
func (h *NGKEX) Start(wg *sync.WaitGroup) {
	wg.Add(1)
	go func() {
		h.Run()
		wg.Done()
...
// Run implements the NGKEX wrapper
func (h *NGKEX) Run() {
	if h.Verbose {
...
func (h *NGKEX) UpdateTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (h *NGKEX) GetTickerPrice(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (h *NGKEX) GetOrderbookEx(p currency.Pair, assetType string) (orderbook.Base, error) {
...
func (h *NGKEX) UpdateOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
...
func (h *NGKEX) GetAccountID() ([]Account, error) {
...
// NGKEX exchange - to-do
func (h *NGKEX) GetAccountInfo() (exchange.AccountInfo, error) {
...
// withdrawals
func (h *NGKEX) GetFundingHistory() ([]exchange.FundHistory, error) {
	var fundHistory []exchange.FundHistory
	return fundHistory, common.ErrFunctionNotSupported
}

// GetExchangeHistory returns historic trade data since exchange opening.
func (h *NGKEX) GetExchangeHistory(p currency.Pair, assetType string) ([]exchange.TradeHistory, error) {
...
func (h *NGKEX) SubmitOrder(p currency.Pair, side exchange.OrderSide, orderType exchange.OrderType, amount, price float64, clientID string) (exchange.SubmitOrderResponse, error) {
...
// market conversion
func (h *NGKEX) ModifyOrder(action *exchange.ModifyOrder) (string, error) {
	return "", common.ErrFunctionNotSupported
}

// CancelOrder cancels an order by its corresponding ID number
func (h *NGKEX) CancelOrder(order *exchange.OrderCancellation) error {
...
func (h *NGKEX) GetOrderInfo(orderID string) (exchange.OrderDetail, error) {
	var orderDetail exchange.OrderDetail
	return orderDetail, common.ErrNotYetImplemented
}

// GetDepositAddress returns a deposit address for a specified currency
func (h *NGKEX) GetDepositAddress(cryptocurrency currency.Code, accountID string) (string, error) {
	return "", common.ErrFunctionNotSupported
}

// WithdrawCryptocurrencyFunds returns a withdrawal ID when a withdrawal is
// submitted
func (h *NGKEX) WithdrawCryptocurrencyFunds(withdrawRequest *exchange.WithdrawRequest) (string, error) {
...
func (h *NGKEX) WithdrawFiatFunds(withdrawRequest *exchange.WithdrawRequest) (string, error) {
	return "", common.ErrFunctionNotSupported
}

// WithdrawFiatFundsToInternationalBank returns a withdrawal ID when a
// withdrawal is submitted
func (h *NGKEX) WithdrawFiatFundsToInternationalBank(withdrawRequest *exchange.WithdrawRequest) (string, error) {
	return "", common.ErrFunctionNotSupported
}

// GetWebsocket returns a pointer to the exchange websocket
func (h *NGKEX) GetWebsocket() (*wshandler.Websocket, error) {
	return h.Websocket, nil
}

// GetFeeByType returns an estimate of fee based on type of transaction
func (h *NGKEX) GetFeeByType(feeBuilder *exchange.FeeBuilder) (float64, error) {
...
func (h *NGKEX) GetActiveOrders(getOrdersRequest *exchange.GetOrdersRequest) ([]exchange.OrderDetail, error) {
...
func (h *NGKEX) GetOrderHistory(getOrdersRequest *exchange.GetOrdersRequest) ([]exchange.OrderDetail, error) {
	if len(getOrdersRequest.Currencies) == 0 {
		return nil, errors.New("currency must be supplied")
	}
...
func (h *NGKEX) SubscribeToWebsocketChannels(channels []wshandler.WebsocketChannelSubscription) error {
...
func (h *NGKEX) UnsubscribeToWebsocketChannels(channels []wshandler.WebsocketChannelSubscription) error {
	h.Websocket.RemoveSubscribedChannels(channels)
	return nil
}

// GetSubscriptions returns a copied list of subscriptions
func (h *NGKEX) GetSubscriptions() ([]wshandler.WebsocketChannelSubscription, error) {
	return h.Websocket.GetSubscriptions(), nil
}

// AuthenticateWebsocket sends an authentication message to the websocket
func (h *NGKEX) AuthenticateWebsocket() error {
	return h.wsLogin()
}
